...
<div id="wrapper">
    ...
    <section id="inner-headline">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="pageTitle">All options page</h2>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="info-blocks-in">
                        <table class="table table-hover text-center m-2">
                            ...
                            <c:forEach var="optionVar" items="#{optionsList}">
                                <tr>
                                    <td><c:out value="${optionVar.name}"/></td>
                                    <td><c:out value="${optionVar.description}"/></td>
                                    <td><c:out value="${optionVar.price}"/></td>
                                    <td><c:out value="${optionVar.connectionCost}"/></td>
                                    <td>
                                        <a class="btn btn-block text-uppercase btn-danger"
                                           href="<c:url value="/admin/deleteOption/${optionVar.id}"/>">Delete</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
