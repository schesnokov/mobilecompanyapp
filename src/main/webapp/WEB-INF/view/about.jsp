  ...
  <div id="wrapper">
    ...
    <section id="content" class="">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <p class="text-center">Allow us to provide perfect safe connection with your friends and family. Also you could be patient about your conversations with your bussiness partners and your unpaided fee.</p>
          </div>
        </div>
        <div class="about">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <p>Our connection between user are end-to-end encryption. All your's calls and messages will be safe and either Yarovaya's law can't brake your privacy.
